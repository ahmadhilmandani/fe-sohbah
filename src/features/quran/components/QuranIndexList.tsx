...
const QuranIndexList: ParentComponent<QuranIndexListT> = (props) => {
  ...
  return (
    <>
      <div onClick={goToReadSurah} class="block border-b-[0.3px] border-muted-200 hover:cursor-pointer hover:bg-tertiary-50/35 p-3 lg:p-8 ">
          ...
          <div class="flex justify-between items-center gap-3">
            ...
            <div>
              ...
              <div class="flex items-center gap-3 text-muted-400">
                {mergedProps.tempatTurun} • {mergedProps.jumlahAyat} ayat
              </div>
            </div>
          </div>
